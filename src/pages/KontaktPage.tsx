...
const KontaktPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <title>Kontakt | MT AUTOS Sučany</title>
        <meta
          name="description"
          content="Kontaktujte nás - MT AUTOS Sučany. Predaj, výkup a dovoz vozidiel. Adresa, telefón, email a otváracie hodiny."
        />
      </Helmet>
          ...
          <div className="rounded-lg overflow-hidden shadow-lg">
            ...
            <div className="p-6 bg-white">
              ...
              {formStatus.type !== 'idle' && (
                <div
                  className={`p-4 rounded mb-4 ${formStatus.type === 'success'
